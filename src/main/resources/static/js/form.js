...
function init(func) {
	...
	$("#newForm").click(function() {
		window.location.href = "/form/goNew";
	});
...
function dealField(id) {
    window.location.href = "/formField/goList/" + id;
}

function update(id) {
    window.location.href = "/form/goUpdate/" + id;
}

function goForm(id) {
    window.location.href = "/form/goForm/" + id;
}
